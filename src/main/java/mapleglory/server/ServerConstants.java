...
public final class ServerConstants {
    ...
    public static final byte[] CENTRAL_HOST = Util.getHost(Util.getEnv("IP_ADDRESS", "127.0.0.1"));
    public static final int CENTRAL_PORT = Util.getEnv("CENTRAL_PORT", 8282);

    public static final byte[] SERVER_HOST = Util.getHost(Util.getEnv("IP_ADDRESS", "127.0.0.1"));
