...
public final class ServerConstants {
    ...
    public static final byte[] CENTRAL_HOST = Util.getHost(Util.getEnv("CENTRAL_HOST", "176.228.66.214"));
    public static final int CENTRAL_PORT = Util.getEnv("CENTRAL_PORT", 8282);

    public static final byte[] SERVER_HOST = Util.getHost(Util.getEnv("SERVER_HOST", "176.228.66.214"));
